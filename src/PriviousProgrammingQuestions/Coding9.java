...
here is to find the single-digit sum of the given number ‘N’ by 
...
Repeat step 2 ‘R’ times i.e. 3 tims  
(9+9)+(9+9)+(9+9) = 18+18+18 =54
...
Repeat step 2 ‘R’ times i.e. 2 times  
(1+2+3+4)+(1+2+3+4)= 10+10=20
...
The output should be a positive integer number or 
print the message (if any) given in the problem statement. 
